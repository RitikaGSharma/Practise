...
driver.findElement(By.cssSelector("input[id='password_step_input']")).sendKeys("abcde");
WebElement dropdown_date=driver.findElement(By.cssSelector("select[id='day']"));
WebElement dropdown_month=driver.findElement(By.cssSelector("select[id='month']"));
